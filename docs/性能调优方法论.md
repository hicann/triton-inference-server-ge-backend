...
配置 分档+锁核+float16 成功后，参考cnclip模型，吞吐如下：
```
Request concurrency: 64
  Client: 
    Request count: 7743
    Throughput: 3059.56 infer/sec
    Avg latency: 165814 usec (standard deviation 47602 usec)
    p50 latency: 128493 usec
    p90 latency: 259092 usec
    p95 latency: 269777 usec
    p99 latency: 293959 usec
    Avg HTTP time: 165805 usec (send/recv 5745 usec + response wait 160060 usec)
  Server: 
    Request count: 0
Inferences/Second vs. Client Average Batch Latency
Concurrency: 64, throughput: 3059.56 infer/sec, latency 165814 usec
```
性能对比动态图，有一倍以上的吞吐提升。
